...
/*! \typedef struct _gx_color_yuv GXColorYUV
 * \brief Structure used to pass YUV colors to some GX functions.
 */
typedef struct _gx_color_yuv {
 	u8 y;			/*!< Luminance component. */
 	u8 u;			/*!< Blue chrominance component. */
 	u8 v;			/*!< Red chrominance component. */
	u8 pad;			/*!< Padding byte. */
} GXColorYUV;
