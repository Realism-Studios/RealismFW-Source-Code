...
const SpriteData BombBroSpriteData = {ProfileId::BombBro, 8, 0xFFFFFFF0, 0, 0x10, 8, 0x10, 0, 0, 0, 0, 0};
Profile BombBroProfile(&daEnBombBros_c::build, SpriteId::BombBro, &BombBroSpriteData, ProfileId::EN_HAMMERBROS, ProfileId::BombBro, "BombBro", BombBroArcList, 0x12);

bool daEnBombBros_c::collisionCat9_RollingObject(ActivePhysics *apThis, ActivePhysics *apOther) {
    if (apOther->owner->profileId == ProfileId::BrosBomb) {
...
void daEnBombBros_c::weaponCreate() {
    ...
    proj = (daBombProjectile_c *)create(ProfileId::BrosBomb, id, &bombVec, (S16Vec *)0, 0);
