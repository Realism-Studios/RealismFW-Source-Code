...
dKPCamera_c *dKPCamera_c::instance = 0;

Profile KP_CameraProfile(&dKPCamera_c::build, ProfileId::KP_Camera, NULL, ProfileId::WM_SINKSHIP, ProfileId::KP_Camera, "KP_Camera", NULL);

dActor_c *dKPCamera_c::build() {
	void *buffer = AllocFromGameHeap1(sizeof(dKPCamera_c));
	dKPCamera_c *c = new(buffer) dKPCamera_c;
...
int dKPCamera_c::onDelete() {
	return true;
}


int dKPCamera_c::onExecute() {
...
void dKPCamera_c::doStuff(float something) {
	camTarget = (Vec){
