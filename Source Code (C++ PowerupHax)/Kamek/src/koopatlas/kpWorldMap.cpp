...
dKPMap_c *dKPMap_c::instance = 0;

Profile KP_MapProfile(&dKPMap_c::build, ProfileId::KP_Map, NULL, ProfileId::WM_SINKSHIP, ProfileId::KP_Map, "KP_Map", NULL);

dActor_c *dKPMap_c::build() {
	void *buffer = AllocFromGameHeap1(sizeof(dKPCamera_c));
	dKPMap_c *c = new(buffer) dKPMap_c;
...
int dKPMap_c::onDelete() { return true; }
int dKPMap_c::onExecute() {
	bgSrtAnm.process();
...
void dKPMap_c::renderer_c::drawOpa() {
	//drawLayers();
}

void dKPMap_c::renderer_c::drawXlu() {
	drawLayers();
}



void dKPMap_c::renderer_c::drawLayers() {
...
void dKPMap_c::renderer_c::beginRendering() {
	currentTexture = 0;
	...
	dKPCamera_c *camObj = dKPCamera_c::instance;
...
void dKPMap_c::renderer_c::renderTileLayer(dKPLayer_s *layer, dKPLayer_s::sector_s *sectors) {
...
void dKPMap_c::renderer_c::renderDoodadLayer(dKPLayer_s *layer) {
...
void dKPMap_c::renderer_c::endRendering() {
}

void dKPMap_c::renderer_c::loadTexture(GXTexObj *obj) {
...
void dKPMap_c::renderer_c::loadCamera() {
	GXLoadPosMtxImm(renderMtx, GX_PNMTX0);
}

void dKPMap_c::renderer_c::loadCamera(Mtx m) {
	GXLoadPosMtxImm(m, GX_PNMTX0);
}



void dKPMap_c::doEffects() {
