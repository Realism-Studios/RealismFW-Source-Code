...
int CrsinInitSubChain_0_LoadsFiles() {
	int count = sizeof(crsinLoadTable) / sizeof(char *);
	SpammyReport("CRSIN will load %d files!\n", count);
	
	DVD_LoadFiles(DVDClass, "Object", crsinLoadTable, count, 0);
	return true;
}