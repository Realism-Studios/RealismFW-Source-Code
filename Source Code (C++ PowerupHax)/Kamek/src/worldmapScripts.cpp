...
// handles behavior for a bunch of scripts: 0x808FB2F0

enum CommandType {
    WIPE_DELAY = 0, // number of frames before wipe begins, arg is frame count
    END_SCRIPT = 5, // arg is always 0
    SET_WIPE = 8,
    START_COURSE = 12, // arg is always 0
    ACTIVATE_VIEW_MAP = 56,
    NORMAL_COURSE_IN, // plays SE_SYS_COURSE_IN and player sounds and animations
};
