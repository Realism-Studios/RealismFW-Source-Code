...
const SpriteData PataGaloombaSpriteData = {ProfileId::Paragaloomba, 8, 0xFFFFFFF0, 0, 8, 8, 8, 0, 0, 0, 0, 0};
Profile PataGaloombaProfile(&daEnPataKuribon_c::build, SpriteId::Paragaloomba, &PataGaloombaSpriteData, ProfileId::Paragaloomba, ProfileId::Paragaloomba, "Paragaloomba", PataGaloombaArcList, 0x12);
