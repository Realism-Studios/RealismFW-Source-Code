...
int Songs[16][4][16][3] = {
	...
	{ // Song 1 - Me fucking around |***  |
		{{8,8,0},{8,8,1},{8,7,2},{8,7,3},{8,7,4},{8,3,5},{8,6,6},{8,1,7},{8,5,8},{8,2,9},{8,4,10},{8,7,11},{8,2,12},{8,8,13},{8,17,14},{0,0,0}},
		{{1,13,0},{0,0,0}},
		{{0,0,0}},
...
int dSingAlong::onCreate() {
	NoMichaelBuble = true;
	PauseManager_c::instance->disablePause = true; // enable no-pause
	...
	SBg = (dSongBlock*)create(ProfileId::SongBlock, 8, &(Vec){x-96.0+(32.0*7), y, z}, &rot, 0);
