...
void PrintContext(u16 OSError, void *_osContext, u32 _dsisr, u32 _dar)
{
    ...
    do
    {
        ...
        {
            nw4r::db::Exception_Printf_(" - %08X RealismASM", stackPointer[1] - dlcode);
        }
