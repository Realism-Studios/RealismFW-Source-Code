...
Profile NipperFireProfile(&daFireBall_Nipper_c::build, ProfileId::NipperPlantFire, NULL, ProfileId::PAKKUN_FIREBALL, ProfileId::NipperPlantFire, "NipperPlantFire", NULL, 0x22);
