...
Profile BombProjProfile(&daBombProjectile_c::build, ProfileId::BrosBomb, NULL, ProfileId::EN_BOMHEI, ProfileId::BrosBomb, "BrosBomb", NULL, 0x22);
...
int daBombProjectile_c::onDelete() {
    projectileCounts[Powerup::BombFlower][which_player]--;
    this->Delete(1);
    return true;
}
