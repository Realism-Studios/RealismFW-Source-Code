SECTIONS {
	/* Bomb Bro */
	__vt__14daEnBrosBase_c = 0x80302714;
	__dt__14daEnBrosBase_cFv = 0x80025e90;
	entryHIO__14daEnBrosBase_cFv = 0x80023f70;
	initType__14daEnBrosBase_cFv = 0x80023f20;
	initPosLv__14daEnBrosBase_cFv = 0x80023f30;
	initMoveCnt__14daEnBrosBase_cFv = 0x80023f40;
	setAttackAnm__14daEnBrosBase_cFv = 0x80024f50;
	beginAttk__14daEnBrosBase_cFv = 0x80025280;
	isAttackOK__14daEnBrosBase_cFv = 0x80025270;
	isInvalidBg__14daEnBrosBase_cFv = 0x800254f0;
	beginJump__14daEnBrosBase_cFv = 0x80025280;
	setJump__14daEnBrosBase_cFv = 0x80025260;
	setJumpCnt__14daEnBrosBase_cFv = 0x80023f60;
	weaponAttack__14daEnBrosBase_cFv = 0x80025530;
	weaponCreate__14daEnBrosBase_cFv = 0x80025510;
	messWithHeldProjRotation__14daEnBrosBase_cFv = 0x80025540;
	calcMoveDir__14daEnBrosBase_cFv = 0x80024cf0;
	getAdjustOffset__14daEnBrosBase_cFv = 0x80025e20;
	calledInMoveBegin__14daEnBrosBase_cFv = 0x80025010;
	getColor__14daEnBrosBase_cFv = 0x80023f10;
	isOnScreen_maybe__14daEnBrosBase_cFv = 0x80025e40;
	setSpeed__14daEnBrosBase_cFv = 0x80023f50;
	getProjReleaseFrameNum__14daEnBrosBase_cFv = 0x80025520;
	getProjCreateFrameNum__14daEnBrosBase_cFv = 0x80025500;
	finalizeState_AirAttack__14daEnBrosBase_cFv = 0x800257f0;
	executeState_AirAttack__14daEnBrosBase_cFv = 0x80025800;
	initializeState_AirAttack__14daEnBrosBase_cFv = 0x800257a0;
	finalizeState_JumpEd__14daEnBrosBase_cFv = 0x80025ac0;
	executeState_JumpEd__14daEnBrosBase_cFv = 0x80025ad0;
	initializeState_JumpEd__14daEnBrosBase_cFv = 0x80025a00;
	finalizeState_Jump__14daEnBrosBase_cFv = 0x800256d0;
	executeState_Jump__14daEnBrosBase_cFv = 0x800256e0;
	initializeState_Jump__14daEnBrosBase_cFv = 0x800256c0;
	finalizeState_JumpSt__14daEnBrosBase_cFv = 0x800255a0;
	executeState_JumpSt__14daEnBrosBase_cFv = 0x800255b0;
	initializeState_JumpSt__14daEnBrosBase_cFv = 0x80025550;
	finalizeState_Attack__14daEnBrosBase_cFv = 0x800252e0;
	executeState_Attack__14daEnBrosBase_cFv = 0x800252f0;
	initializeState_Attack__14daEnBrosBase_cFv = 0x800252a0;
	finalizeState_Move__14daEnBrosBase_cFv = 0x80025020;
	executeState_Move__14daEnBrosBase_cFv = 0x80025030;
	initializeState_Move__14daEnBrosBase_cFv = 0x80024f60;
	_vf238__14daEnBrosBase_cFv = 0x80024580;
	_vf230__14daEnBrosBase_cFv = 0x80024570;
	CreateIceActors__14daEnBrosBase_cFv = 0x80024b10;
	_vf220__14daEnBrosBase_cFPv = 0x80024a70;
	dieFall_End__14daEnBrosBase_cFv = 0x80025c80;
	dieFall_Execute__14daEnBrosBase_cFv = 0x80025c90;
	dieFall_Begin__14daEnBrosBase_cFv = 0x80025c40;
	dieFumi_End__14daEnBrosBase_cFv = 0x80025bc0;
	dieFumi_Execute__14daEnBrosBase_cFv = 0x80025bd0;
	dieFumi_Begin__14daEnBrosBase_cFv = 0x80025b80;
	collisionCat13_Hammer__14daEnBrosBase_cFP13ActivePhysicsP13ActivePhysics = 0x800248c0;
	collisionCat2_IceBall_15_YoshiIce__14daEnBrosBase_cFP13ActivePhysicsP13ActivePhysics = 0x800244d0;
	collisionCat7_GroundPound__14daEnBrosBase_cFP13ActivePhysicsP13ActivePhysics = 0x80024720;
	collisionCatD_Drill__14daEnBrosBase_cFP13ActivePhysicsP13ActivePhysics = 0x800245a0;
	yoshiCollision__14daEnBrosBase_cFP13ActivePhysicsP13ActivePhysics = 0x80024440;
	playerCollision__14daEnBrosBase_cFP13ActivePhysicsP13ActivePhysics = 0x80024340;
	_vf5C__14daEnBrosBase_cFv = 0x80025e50;
	onDraw__14daEnBrosBase_cFv = 0x80024120;
	onExecute__14daEnBrosBase_cFv = 0x800240b0;
	onDelete__14daEnBrosBase_cFv = 0x80024150;
	onCreate__14daEnBrosBase_cFv = 0x80023cc0;
	removeHIO__14daEnBrosBase_cFv = 0x80024180;
	__vt__Q214daEnBrosBase_c14nodeCallback_c = 0x80302a38;
	__dt__Q214daEnBrosBase_c14nodeCallback_cFv = 0x80026040;

	StateID_AirAttack__14daEnBrosBase_c = 0x80352ff4;
	StateID_JumpSt__14daEnBrosBase_c = 0x80b15884;

	BasicBrosIsOnScreen = 0x809f87d0;

	/* General Symbols */
	getNearestPlayerXDirection = 0x80096240;
	MtxToVec = 0x8016f270;
	MtxToRot = 0x8016f190;
	holdEmySound = 0x801987a0;
	DamageYoshi = 0x80151460;
	CallXCompareFuncLT = 0x80064a30;
	getNearestPlayerYDirection = 0x800962a0;
	startEnemySound = 0x80198040;

	/* Muncher */
	exeFrame__10dScStage_c = 0x8042a4e0;
	
	/* Galoomba, Para Galoomba, & Goombud */
	getAnkleCenterPos = 0x800582f0;
	itemPickedUp__13dStageActor_cFP13dStageActor_c = 0x80065820;
	EnBgCheckWall = 0x80097050;
	EnBgCheckFoot = 0x80096f60;
	calcCarryPos = 0x80097a20;
	cancelCarry = 0x8012e650;
	updateWhenCarried = 0x800963b0;
	SetPosForCarry = 0x80075fd0;
	setRide = 0x800d99e0;
	setPlayerCarry = 0x80096330;
	getRemotePlayer = 0x80069530;
	
	/* Nipper Plant */
	Stage_exeFrame = 0x8042a4e0;
	getConnectChild = 0x801626f0;
	getConnectBrNext = 0x80162710;
	__vt__17daFireBall_Base_c = 0x80306D20;
	__dt__17daFireBall_Base_cFv = 0x80041400;
	_vf138__17daFireBall_Base_cFv = 0x800413e0;
	...
	getLightRad__17daFireBall_Base_cFv = 0x80040ff0;
	beginPoisonSplash__17daFireBall_Base_cFf = 0x800411d0;
	beginYoganSplash__17daFireBall_Base_cFf = 0x800410f0;
	beginSplash__17daFireBall_Base_cFf = 0x80041000;
	fireEffect__17daFireBall_Base_cFv = 0x80040d80;
	chgZpos__17daFireBall_Base_cFv = 0x80040d70;
	setBc__17daFireBall_Base_cFv = 0x80040e70;
	setCc__17daFireBall_Base_cFv = 0x80040af0;
	createCheck__17daFireBall_Base_cFv = 0x80040ad0;
	initialize__17daFireBall_Base_cFv = 0x80040ae0;
	finalizeState_EatNow__17daFireBall_Base_cFv = 0x80041340;
	executeState_EatNow__17daFireBall_Base_cFv = 0x80041340;
	initializeState_EatNow__17daFireBall_Base_cFv = 0x80041330;
	finalizeState_EatIn__17daFireBall_Base_cFv = 0x800412f0;
	executeState_EatIn__17daFireBall_Base_cFv = 0x800412f0;
	initializeState_EatIn__17daFireBall_Base_cFv = 0x800412e0;
	finalizeState_Kill__17daFireBall_Base_cFv = 0x800413a0;
	executeState_Kill__17daFireBall_Base_cFv = 0x800413b0;
	initializeState_Kill__17daFireBall_Base_cFv = 0x80041360;
	finalizeState_Move__17daFireBall_Base_cFv = 0x800412c0;
	executeState_Move__17daFireBall_Base_cFv = 0x800412d0;
	initializeState_Move__17daFireBall_Base_cFv = 0x800412b0;
	_vf13C__17daFireBall_Base_cFv = 0x800413d0;
	BrosFireCallBack = 0x807e9410;
	killFireBall__17daFireBall_Base_cFv = 0x80040ec0;
	continueToMeltIce = 0x807f810c;
	dontMeltTheIce = 0x807f812c;
	...
	changePosAngle = 0x80064af0;

	/* barrelfix.cpp thing */
	cvtSndObjctPos = 0x8006a4b0;

	/* dGameCom */
	calcXY__8dGameComFiiPoint2ds = 0x800B3000;
	chkCancelButton__8dGameComFi = 0x800B53F0;
	chkContinue__8dGameComFb = 0x800B5340;
	EasyPairingResume__8dGameComFv = 0x800B45A0;
	EasyPairingStop__8dGameComFv = 0x800B4540;
	getAspectRatio__8dGameComFUc = 0x800B5500;
	getLanguageX__8dGameComFUc = 0x800B45F0;
	getCourseNum__8dGameComeFii = 0x800B4F90;
	getDispCenterX__8dGameComFf = 0x800B30C0;
	getDispCenterY__8dGameComFf = 0x800B30E0;
	getRandomSeed__8dGameComFv = 0x800B2EC0;
	setRandomSeed__8dGameComFUi = 0x800B2EB0;
	getRandom__8dGameComFUi = 0x800B2ED0;
	rndInt__8dGameComFUi = 0x800B2EE0;
	getRandomDp__8dGameComFv = 0x800B2F50;
	rndFX__8dGameComFf = 0x800B2F60;
	getRandomFloat__8dGameComFv = 0x800B2EF0;
	rndF__8dGameComFf = 0x800B2F10;
	initGame__8dGameComFv = 0x800B2FB0;
	isGameStop__8dGameComFUi = 0x800B3B50;
	clearGameStop__8dGameComFv = 0x800B3A20;
	setGameStop__8dGameComFv = 0x800B3A30;
	isNowCourseClear__8dGameComFv = 0x800B4E30;
	isWorldClear__8dGameComFiUc = 0x800B4ED0;
	playerEnterCheck__8dGameComFi = 0x800B4760;
	SetSoftLight_Boss__8dGameComFPQ23m3d5mdl_ci = 0x800B4050;
	SetSoftLight_Enemy__8dGameComFPQ23m3d5mdl_ci = 0x800B4170;
	SetSoftLight_Item__8dGameComFPQ23m3d5mdl_ci = 0x800B43D0;
	SetSoftLight_Map__8dGameComFPQ23m3d5mdl_ci = 0x800B3F50;
	SetSoftLight_MapObj__8dGameComFPQ23m3d5mdl_ci = 0x800B42B0;
	SetSoftLight_Player__8dGameComFPQ23m3d5mdl_ci = 0x800B3E50;

	/* todo: add symbols for minigame/staffcredit funcs */

	m_rnd__8dGameCom = 0x8042A224;
	gameStop__8dGameCom = 0x8042A228;
	...
	/* Pata Kuribo */
	__vt__16daEnPataKuribo_c = 0x80b02360;
	__dt__16daEnPataKuribo_cFv = 0x80a82610;
	vf2E8__16daEnPataKuribo_cFv = 0x80a60240;
	isWakidashi__16daEnPataKuribo_cCFv = 0x80a60250;
	walkEffect__16daEnPataKuribo_cFv = 0x80a57400;
	updateModel__16daEnPataKuribo_cFv = 0x80a57410;
	setWalkSpeed__16daEnPataKuribo_cFv = 0x80a82030;
	vf2D0__16daEnPataKuribo_cFP13dStageActor_c = 0x80a81cd0;
	setTurnState__16daEnPataKuribo_cFv = 0x80a81b70;
	initialize__16daEnPataKuribo_cFv = 0x80a818f0;
	drawModel__16daEnPataKuribo_cFv = 0x80a825b0;
	loadWingModel__16daEnPataKuribo_cFv = 0x80a819c0;
	reactSpinFumiProc__16daEnPataKuribo_cFP13dStageActor_c = 0x80a57500;
	reactFumiProc__16daEnPataKuribo_cFP13dStageActor_c = 0x80a81c60;
	calcModel__16daEnPataKuribo_cFv = 0x80a81a80;
	_vf244__16daEnPataKuribo_cFv = 0x80a57340;
	_vf240__16daEnPataKuribo_cFv = 0x80a57350;
	_vf23C__16daEnPataKuribo_cFv = 0x80a573a0;
	_vf238__16daEnPataKuribo_cFv = 0x80a82080;
	CreateIceActors__16daEnPataKuribo_cFv = 0x80a81e80;
	playEnemyDownSound2__16daEnPataKuribo_cFv = 0x80a57480;
	collisionCat2_IceBall_15_YoshiIce__16daEnPataKuribo_cFP13ActivePhysicsP13ActivePhysics = 0x80a81e00;
	_vf5C__16daEnPataKuribo_cFv = 0x80a57330;
	isBgmSync__16daEnPataKuribo_cCFv = 0x80a60230;
	StateID_Pata_Walk__16daEnPataKuribo_c = 0x80b19d08;

	/* Kuribo */
	__vt__12daEnKuribo_c = 0x80af7de8;
	__dt__12daEnKuribo_cFv = 0x80a575f0;
	vf2E8__12daEnKuribo_cFv = 0x80a57510;
	isWakidashi__12daEnKuribo_cCFv = 0x80a57520;
	walkEffect__12daEnKuribo_cFv = 0x80a57400;
	updateModel__12daEnKuribo_cFv = 0x80a57410;
	setWalkSpeed__12daEnKuribo_cFv = 0x80a56450;
	setTurnState__12daEnKuribo_cFv = 0x80a56470;
	initialize__12daEnKuribo_cFv = 0x80a56070;
	drawModel__12daEnKuribo_cFv = 0x80a57460;
	loadWingModel__12daEnKuribo_cFv = 0x80a57470;
	reactYoshiFumiProc__12daEnKuribo_cFP13dStageActor_c = 0x80a574f0;
	reactSpinFumiProc__12daEnKuribo_cFP13dStageActor_c = 0x80a57500;
	_vf244__12daEnKuribo_cFv = 0x80a57340;
	_vf240__12daEnKuribo_cFv = 0x80a57350;
	_vf23C__12daEnKuribo_cFv = 0x80a573a0;
	CreateIceActors__12daEnKuribo_cFv = 0x80a56620;
	playEnemyDownSound2__12daEnKuribo_cFv = 0x80a57480;
	collisionCat7_GroundPound__12daEnKuribo_cFP13ActivePhysicsP13ActivePhysics = 0x80a56410;
	_vf5C__12daEnKuribo_cFv = 0x80a57330;
	onDelete__12daEnKuribo_cFv = 0x80a563d0;
	isBgmSync__12daEnKuribo_cCFv = 0x80a575e0;

    /* KuriboBase */
	__vt__16daEnKuriboBase_c = 0x80304c38;
	__dt__16daEnKuriboBase_cFv = 0x80032930;
	vf2E8__16daEnKuriboBase_cFv = 0x80031880;
	isWakidashi__16daEnKuriboBase_cCFv = 0x800315a0;
	walkEffect__16daEnKuriboBase_cFv = 0x80032350;
	updateModel__16daEnKuriboBase_cFv = 0x80032300;
	playWalkAnim__16daEnKuriboBase_cFv = 0x80031df0;
	setWalkSpeed__16daEnKuriboBase_cFv = 0x80031f90;
	vf2D0__16daEnKuriboBase_cFP13dStageActor_c = 0x80031ec0;
	setTurnState__16daEnKuriboBase_cFv = 0x80031780;
	initialize__16daEnKuriboBase_cFv = 0x800312d0;
	drawModel__16daEnKuriboBase_cFv = 0x800315e0;
	loadWingModel__16daEnKuriboBase_cFv = 0x80031360;
	loadModel__16daEnKuriboBase_cFv = 0x80031370;
	createModel__16daEnKuriboBase_cFv = 0x800312e0;
	reactYoshiFumiProc__16daEnKuriboBase_cFP13dStageActor_c = 0x80031940;
	reactSpinFumiProc__16daEnKuriboBase_cFP13dStageActor_c = 0x80031870;
	vf2AC__16daEnKuriboBase_cFv = 0x80031990;
	reactFumiProc__16daEnKuriboBase_cFP13dStageActor_c = 0x80031950;
	calcModel__16daEnKuriboBase_cFv = 0x800315f0;
	finalizeState_TrplnJump__16daEnKuriboBase_cFv = 0x800325b0;
	executeState_TrplnJump__16daEnKuriboBase_cFv = 0x800325c0;
	initializeState_TrplnJump__16daEnKuriboBase_cFv = 0x80032570;
	finalizeState_Turn__16daEnKuriboBase_cFv = 0x800323e0;
	executeState_Turn__16daEnKuriboBase_cFv = 0x800323f0;
	initializeState_Turn__16daEnKuriboBase_cFv = 0x80032370;
	finalizeState_Walk__16daEnKuriboBase_cFv = 0x80032160;
	executeState_Walk__16daEnKuriboBase_cFv = 0x80032170;
	initializeState_Walk__16daEnKuriboBase_cFv = 0x800320c0;
	_vf244__16daEnKuriboBase_cFv = 0x80032800;
	_vf240__16daEnKuriboBase_cFv = 0x80032810;
	_vf23C__16daEnKuriboBase_cFv = 0x80032860;
	_vf220__16daEnKuriboBase_cFPv = 0x80031ab0;
	playEnemyDownSound2__16daEnKuriboBase_cFv = 0x800328c0;
	dieOther_End__16daEnKuriboBase_cFv = 0x80032780;
	dieOther_Execute__16daEnKuriboBase_cFv = 0x80032790;
	dieOther_Begin__16daEnKuriboBase_cFv = 0x800326f0;
	yoshiCollision__16daEnKuriboBase_cFP13ActivePhysicsP13ActivePhysics = 0x80031890;
	playerCollision__16daEnKuriboBase_cFP13ActivePhysicsP13ActivePhysics = 0x80031790;
	spriteCollision__16daEnKuriboBase_cFP13ActivePhysicsP13ActivePhysics = 0x80031730;
	_vf5C__16daEnKuriboBase_cFv = 0x800327f0;
	onDraw__16daEnKuriboBase_cFv = 0x800315b0;
	onExecute__16daEnKuriboBase_cFv = 0x80031470;
	onDelete__16daEnKuriboBase_cFv = 0x80031460;
	onCreate__16daEnKuriboBase_cFv = 0x80031210;
	isBgmSync__16daEnKuriboBase_cCFv = 0x80032360;
	isOnEnLiftRemoconTrpln__16daEnKuriboBase_cFv = 0x80032080;
	StateID_TrplnJump__16daEnKuriboBase_c = 0x8035386c;
	StateID_Turn__16daEnKuriboBase_c = 0x8035382c;
	StateID_Walk__16daEnKuriboBase_c = 0x803537ec;
	dEn_c_EnBgCheck = 0x80096e60;
	...
	playerManagerInitStage__Fv = 0x8005eb10;

	FUN_80069E50__Fv = 0x80069e50;
	FreeBackgroundList__Fv = 0x80101fb0;

	positionButtons__19dModelPlayManager_cFv = 0x80795ad0;

	instance__9dScWMap_c = 0x8042a514;
	mWmArcName__9dScWMap_c = 0x8042A520;
	mWorldNo__9dScWMap_c = 0x8042A52D;
	mSceneNo__9dScWMap_c = 0x8042A52E;

	createBootParam__9dScWMap_cFv = 0x80102B50;

	RouteInfos = 0x80374BA8;
	UnlinkWorld__Fv = 0x800FE220;
	FreeWMScene__FPvi = 0x80927DC0;

	instance__18dWmEffectManager_c = 0x8042A54C;
	destroy__18dWmEffectManager_cFv = 0x801031A0;

	instance__14dWmSeManager_c = 0x8042A55C;
	destroy__14dWmSeManager_cFv = 0x80104020;

	/* font crap */
	instance__10dFontMng_c = 0x80358b48;
	...
	getStockItem__7dInfo_cFi = 0x800BB3D0;

	replayDuration = 0x80429318;
	stageScreenType = 0x8042a4e4;
	isStageReplay = 0x8042a504;
	levelType = 0x8042a500;

	SomeStageRelatedValue = 0x8042a506;

	exitingStage = 0x8042a4fd;

	m_OtasukeAfter = 0x8042a2c2;

	DAT_8099E0F8 = 0x8099E0F8;
	...
	AssembleWorldMapSettings__Fiii = 0x80102B70;
	...
	/* random states */
	StateID_PressButtonExitAnimeEndWait__20dEventOpeningTitle_c = 0x80991ef0;
	...
	/* file selection crap */
	returnSelectedFile__13dFileSelect_cFv = 0x807831d0;

	StateID_ButtonSelectAnimeEndWait__13dFileSelect_c = 0x80991ff0;
	StateID_FromCopyOrDeleteBeforeButtonReturn__13dFileSelect_c = 0x80992130;
	StateID_MultiButtonExitAnimeEndWait__13dFileSelect_c = 0x80992170;
	StateID_ButtonHitAnimeEndWait__13dFileSelect_c = 0x80992070;
	StateID_ReturnTitle__13dFileSelect_c = 0x809920b0;

	/* world map pause menu states, idk if i'll need all these */
	StateID_InitWait__19dCourseSelectMenu_c = 0x809915D0;
	StateID_OpenAnimeEndWait__19dCourseSelectMenu_c = 0x80991610;
	StateID_ButtonChangeAnimeEndWait__19dCourseSelectMenu_c = 0x80991650;
	StateID_PauseDisp__19dCourseSelectMenu_c = 0x80991690;
	StateID_HitAnimeEndWait__19dCourseSelectMenu_c = 0x809916D0;
	StateID_ClouseAnimeEndWait__19dCourseSelectMenu_c = 0x80991710;

	/* CourseSelectManager states */
	StateID_StockItemSelectWait__22dCourseSelectManager_c = 0x809a2500;

	StateID_CollectionCoinWait__22dCourseSelectManager_c = 0x809A2540;
	StateID_CharacterChangeWait__22dCourseSelectManager_c = 0x809A2580;
	StateID_InterruptSaveWindowOpen__22dCourseSelectManager_c = 0x809A2740; /* Quick Save */
	StateID_SaveWindowOpen__22dCourseSelectManager_c = 0x809A25C0;
	StateID_TitleConfirmationWindowOpen__22dCourseSelectManager_c = 0x809A2980;

	StateID_PushAnimeEndWait__22dCourseSelectManager_c = 0x809A24C0;

	doneWithSpawnSettingsActor = 0x8092707C;


	/* Star Coins Menu */
	positionCoinBars__21dCollectionCoinBase_cFv = 0x80776470;

	StateID_KeyWait__17dCollectionCoin_c = 0x80990FF0;
	StateID_ExitAnimeEndWait__17dCollectionCoin_c = 0x809910b0;
	toPreviousPage__17dCollectionCoin_cFv = 0x80774a00;
	toNextPage__17dCollectionCoin_cFv = 0x80774ab0;


	IsCourseClear = 0x800faf50;

	/* Temp Completion Shit */
	StarCoinStatusArray = 0x803744B0;
	CheckIfCoinCollected__9SaveBlockFiii = 0x800ce300;
	instance__7dInfo_c = 0x8042a25c;
	isCyuukanStart__10dCyuukan_cFiUcUc = 0x8008f000;

	/* Sound Scene Manager */
	instance__11SndSceneMgr = 0x8042a788;
	createInstance__11SndSceneMgrFv = 0x8019b580;
	deleteInstance__11SndSceneMgrFv = 0x8019b5d0;
	openWindow__11SndSceneMgrFUi = 0x8019cb40;
	closeWindow__11SndSceneMgrFv = 0x8019cdb0;
	openWorldSelect__11SndSceneMgrFv = 0x8019cb20;
	closeWorldSelect__11SndSceneMgrFv = 0x8019cb30;
	pauseGame__11SndSceneMgrFv = 0x8019c930;
	startGame__11SndSceneMgrFv = 0x8019c9c0;
	startGoal__11SndSceneMgrFb = 0x8019c320;
	startFanfare__11SndSceneMgrFUi = 0x8019c390;
	startMiss__11SndSceneMgrFv = 0x8019c470;
	startMultiAllBubble__11SndSceneMgrFv = 0x8019c4b0;

	GoToSpecificWorld__FUiUi = 0x801027a0;
	GetMapModelName__FiPc = 0x80102780;
	//GetMapSpecificResName__FPi = 0x80926A10;
	GetEnemyResNames__FPi = 0x80926940;

	GetCurrentWorld__Fv = 0x808deb70;
	GetLevelGroup__F11LevelNumber = 0x800f9950;

	doneWithChangeGroupNames = 0x8077ABF0;

	assignSomeColoursToWindow__FPQ34nw4r3lyt4Panei = 0x800b3c50;

	instance__13Pausewindow_c = 0x8042A61C;

	loadLayout__20dEventOpeningTitle_cFv = 0x80781d00;

	collectionCoinSet__20dCourseSelectGuide_cFv = 0x80010dd0;
	onDelete__20dCourseSelectGuide_cFv = 0x80010B40;
	...
	EggSqrt__Ff = 0x802BE760;
	GetLoopPosX__Ff = 0x80101BB0;

	PlBaseDirectionSpeedModifier = 0x8042BB20;

	instance__Q24dHbm8Manage_c = 0x8042A594;
	...
	setupModelThings__10daWMItem_cFv = 0x808D4F40;

	useItem__12dStockItem_cFv = 0x807B00A0;
	setupButtonEffect__12dStockItem_cFv = 0x807B0470;
	storeCountToShadow__12dStockItem_cFii = 0x807B0340;

	StateID_ButtonChangeAnimeEndWait__12dStockItem_c = 0x80995868;
	StateID_ItemSelectWait__12dStockItem_c = 0x809958A8;
...
/* Small Score (Manager) symbols */
	/*DisplayScoreAddPopup*/

	MarioPointColor1 = 0x80358D78;
	MarioPointColor2 = 0x80358D8C;
	LuigiPointColor1 = 0x80358D7C;
	LuigiPointColor2 = 0x80358D90;
	KinoBPointColor1 = 0x80358D80;
	KinoBPointColor2 = 0x80358D94;
	KinoYPointColor1 = 0x80358D84;
	KinoYPointColor2 = 0x80358D98;
	DefaultPointColor1 = 0x80358D88;
	DefaultPointColor2 = 0x80358D9C;

	changeSmallScoreColor__FPQ34nw4r3lyt7TextBoxi = 0x800b4780;

	instance__20dSmallScoreManager_c = 0x8042a5b0;
...
/* CobCourse */
	...
	FUN_808D3F30__12daWMIsland_cFv = 0x808D3F30;


/* World Map button press crap */
	FUN_809087A0__Fv = 0x809087a0;
	isControllerWiimote__Fi = 0x800fd4a0;
	hideToadBalloons__Fv = 0x808d8720;

	FUN_80908DA0__9daWmMap_cFv = 0x80908da0;
	FUN_80904370__9daWmMap_cFi = 0x80904810;
	navigatePath__9daWmMap_cFv = 0x80904810;
	enterCourse__9daWmMap_cFv = 0x80904440;

	m_instance__14dWorldCamera_c = 0x8042a564;

	instance__11dCsSeqMng_c = 0x8042A48C;
	areAnyScriptsQueued__11dCsSeqMng_cFv = 0x80915630;
	addScriptToQueue__11dCsSeqMng_cFiPvP14dWorldCamera_ci = 0x801017c0;
	FUN_80915600__11dCsSeqMng_cFv = 0x80915600;
	...
	isCarry__10daPlBase_cFv = 0x801268F0;
	setPowerup__10daPlBase_cFi = 0x80056BC0;
	getMukiAngle__10daPlBase_cFi = 0x80047480;
	isItemKinopio__10daPlBase_cFv = 0x80020BE0;
	getGravityData__10daPlBase_cFv = 0x80049040;

	setScrollMode__7dAcPy_cFSc = 0x80147390;
	onCreate__7dAcPy_cFv = 0x80144EA0;
	AcPy__onCreate = 0x80144EA0;
	AcPy__ctor = 0x801443F0;
	AcPy__dtor = 0x80144820;
	__dt__21dPlayerModelHandler_cFv = 0x800D6EF0;
	__dt__10dAcPyKey_cFv = 0x8005DFF0;

	CheckFireballLimit__Fii = 0x8011B060;
	CheckIceballLimit__Fii = 0x80124700;

	setCurrentMusic__FUc = 0x8006A6A0;
	...
	instance__14PauseManager_c = 0x8042A2B8;
	...
	restCoinAnimeCheck__14dGameDisplay_cFv = 0x801589d0;
	areaCheck__14dGameDisplay_cFv = 0x80158a50;
	relatedToPaneAlpha__14dGameDisplay_cFv = 0x80158bd0;

	restDispSetup__14dGameDisplay_cFv = 0x801586c0;
	sub_801585C0__14dGameDisplay_cFv = 0x801585c0;
	otehonPosChange__14dGameDisplay_cFv = 0x80158240;

	setPlayNum__14dGameDisplay_cFPUc = 0x801599c0;
	setCoinNum__14dGameDisplay_cFi = 0x80159aa0;
	setTime__14dGameDisplay_cFi = 0x80159c00;
	...
	/* dPlayerInput_c */
	getHeldDown__10dAcPyKey_c = 0x8005E500;
	getHeldUp__10dAcPyKey_c = 0x8005E4F0;
	detectGroundPound__10dAcPyKey_c = 0x8005E300;
	getHeldTwo__10dAcPyKey_c = 0x8005E580;
	getHeldTwo__10dAcPyKey_cFv = 0x8005E580;
	setFlag__10dAcPyKey_cFQ210dAcPyKey_c5Flags = 0x8005E3B0;
	setPermanentForcedButtons__10dAcPyKey_cFUi = 0x8005E910;
	setTransientForcedButtons__10dAcPyKey_cFUi = 0x8005E960;
	unsetPermanentForcedButtons__10dAcPyKey_cFUi = 0x8005E930;
	areWeShaking__10dAcPyKey_cFv = 0x8005E780;
	willShootProjectile__10dAcPyKey_cFv = 0x8005E690;
	...
	GetRail = 0x800D91B0;
	instance__8dQuake_c = 0x8042A2E8;
	...
	FUN_80926210__FP10dScStage_c = 0x80926210;

	GetCurrentCamera__Fv = 0x80164C70;
	CameraGXSetViewport__Fi = 0x80254480;
	CameraGXSetScissor__Fi = 0x802545E0;

	instance__11dBeansKuriboMng_c = 0x8042A0A0;
	instance__11dBlockMgr_c = 0x8042A0F8;
	instance__11dScoreMng_c = 0x8042A330;

	instance__16dWaterEntryMng_c = 0x8042A3E0;
	instance__13dCurtainMng_c = 0x8042A180;

	instance__14dGoalManager_c = 0x8042A5A4;
	...
	getCarryPlayer__7dAcPy_cFv = 0x8012DD20;
	changeState__10daPlBase_cFP12dStateBase_cUi = 0x80047390;
	...
	StateID_Fire__7dAcPy_c = 0x803763B0;
	...
	CancelSelectCursor = 0x8010C890;
	SelectCursorPointer = 0x8042A5A8;

	updateCursor__15dSelectCursor_cFPQ34nw4r3lyt4Paneib = 0x8010C900;
	applyTargetAlpha__15dSelectCursor_cFPQ34nw4r3lyt4Panei = 0x8010CAB0;

	instance__15dSelectCursor_c = 0x8042A5A8;
...
/* Scrolling is annoying, clown car goes here! */
	...
	__construct_array__FPvPvPvUiUi = 0x802DCC90;
	...
	loadPlayer__12da2DPlayer_cFv = 0x808C5990;
	Player2D__ctor = 0x808C5130;
	Player2D__dtor = 0x808C5500;
...
/* Back to other shit I didn't want to scroll for */
	...
	DoSceneChange__FUsUib = 0x800E1F50;
	ReturnToAnotherSceneAfterLevel__FUsUiii = 0x80102370;
...
/* Boss Related */
	...
	instance__11dEnemyMng_c = 0x8042A1F0;
...
/* Mr Sun Related */
	...
	CurrentWipeType = 0x80429320;
	StageExeFrame = 0x8042a4e0;
	...
	setMatrix__21dPlayerModelHandler_cFPA3_A4_f = 0x800D6FA0; /* doesn't actually exist */
	...
	OSAllocFromMEM1ArenaLo__FUiUi = 0x801AC060;
	OSLoadFont__FP12OSFontHeaderPv = 0x801B05C0;
	MEM1ArenaLo = 0x804297F8;
	DCFlushRange__FPvUi = 0x801AC5B0;
	VIInit__Fv = 0x801BC8E0;
	VISetBlack__Fi = 0x801BDF90;
	VIGetRetraceCount__Fv = 0x801BE010;
	VIFlush__Fv = 0x801BDDF0;
	ConfigureVideo__FUsUs = 0x801AF5F0;
	VISetNextFrameBuffer__FPv = 0x801BDF10;
	ScreenReport__FPvUiUiP13_gx_color_yuvUiUiUiPCc = 0x801AF2C0;
	GXAbortFrame = 0x801C4E20;
	...
	findExtUserDataByName__FPQ34nw4r3lyt4Panei = 0x802AC5C0;
	...
	__ct__Q23m2d14ResAccLoader_cFv = 0x80006aa0;
	__dt__Q23m2d14ResAccLoader_cFv = 0x80006af0;
	...
	GetSomeWidescreenCrap__F7Point2d = 0x800B5140;
	...
	initLoadGame__8SaveFileFSc = 0x800E1930;
	SaveGame__FPvb = 0x8092F5F0;

	loadGameModels = 0x8091ec50;
	...
	requestFile__F12dDvdLoader_cPCcUcPv = 0x8008F1B0;
	__vt__12dDvdLoader_c = 0x80311140;

	/* More Font Hacks */
	ResFontSetResource__FPQ44nw4r2ut6detail11ResFontBaseP16BinaryFileHeader = 0x8022C4E0;
	...
	DoStartStaffCredit__FPv = 0x800BB8D0;
	SetSomeConditionShit__FiiUi = 0x801027E0;
	CheckConditionShit__FiiUi = 0x80102860;
	...
	setPlrID__9SaveBlockFii = 0x800CE150;
	setPlrMode__9SaveBlockFiUc = 0x800CE170;
	setRest__9SaveBlockFiUc = 0x800CE190;
	setCreateItem__9SaveBlockFiUc = 0x800CE1B0;
	setKinopioCourseNo__9SaveBlockFii = 0x800CE620;
	setEnemyPathNode__9SaveBlockFiiUc = 0x800CE5A0;
	setEnemyDirection__9SaveBlockFiiUc = 0x800CE5E0;
	setIbaraNow__9SaveBlockFi = 0x800CE640;
	...
	SetScreenFader__Fi = 0x800B0DB0;
	PlayInFader__Fs = 0x800b0a20;
	PlayOutFader__Fs = 0x800b0a90;

	finishedFadeIn__FPv = 0x8016de60;
	finishedFadeOut__FPv = 0x8016de90;

	mFaderPtr = 0x8042a720;

	instance__13dWipeCircle_c = 0x80429F10;
	instance__12dWipeDokan_c = 0x80429F18;
	instance__12dWipeKuppa_c = 0x80429F20;
	instance__12dWipeMario_c = 0x80429F28;

	calc__8dFader_cFv = 0x800B0B00;
	draw__8dFader_cFv = 0x800B0B20;
	createFader__8dFader_cFP23EGG4Heap = 0x800B0B50;
	startFadeIn__8dFader_cFUs = 0x800B0A20;
	startFadeOut__8dFader_cFUs = 0x800B0A90;
	setFader__8dFader_cFi = 0x800B0DB0;

	PeachCastleSeqMgrObjPtr = 0x8099E0F8;
	ActivateModelPlay__FPv = 0x8088e030;
	DeactivateModelPlay__FPv = 0x8088e090;
	...
	setScreenColorForScene__FP9_gx_color = 0x800E4940;
	...
	playPlayerSound__10daPlBase_cFil = 0x80057E70;
	playPlayerSound__FP10daPlBase_c3SFXl = 0x80057E70;
	CreateActor = 0x80064610;
	Actor_SearchByName = 0x80162E90;

	isHammerOffScreen__10daHammer_cFv = 0x807FCFE0;
	daKokoopaBall_c__onDelete = 0x80822FA0;
	...
	__dt__Q23EGG6EffectFv = 0x802D7E10;
	...
	instance__11dActorMng_c = 0x8042A020;
	killAllEnemiesAtLevelEnd__11dActorMng_cFi = 0x80066A40;

	JrClownEndDemoState = 0x80999988;
	JrClownDemoWaitState = 0x80999884;
	ClownDemoWaitState = 0x803580DC;

	spawnCoinJump__11dActorMng_cFRC7Point3diii = 0x80066630;
