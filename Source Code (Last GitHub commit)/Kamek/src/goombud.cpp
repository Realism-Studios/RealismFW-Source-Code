...
const SpriteData GoombudSpriteData = {ProfileId::Goombud, 8, 0xFFFFFFF0, 0, 8, 8, 8, 0, 0, 0, 0, 0};
Profile GoombudProfile(&daEnKakibon_c::build, SpriteId::Goombud, &GoombudSpriteData, ProfileId::Goombud, ProfileId::Goombud, "Goombud", GoombudArcList, 0x12);
