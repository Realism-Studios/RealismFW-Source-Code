...
static const char *stockItemGroupNames[] = {
	...
	"BubbleGroup", "BubbleGroup", "BubbleGroup",
	"BoomerGroup", "BoomerGroup", "BoomerGroup"
};
...
enum StockItemAnimation {
	...
	ON_BUBBLE, HIT_BUBBLE, OFF_BUBBLE,
	ON_BOOMER, HIT_BOOMER, OFF_BOOMER,

	STOCK_NUM_ANIMS // make sure you update the group names, ids, and this enum so everything matches up
};
