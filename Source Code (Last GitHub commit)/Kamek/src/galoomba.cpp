...
const SpriteData GaloombaSpriteData = {ProfileId::Galoomba, 8, 0xFFFFFFF0, 0, 8, 8, 8, 0, 0, 0, 0, 0};
Profile GaloombaProfile(&daEnKuribon_c::build, SpriteId::Galoomba, &GaloombaSpriteData, ProfileId::Galoomba, ProfileId::Galoomba, "Galoomba", GaloombaArcList, 0x12);
